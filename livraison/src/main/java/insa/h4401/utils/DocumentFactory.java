...
public class DocumentFactory {
     ...
     *
     * @param file file used to create the document
     * @return A RouteDocument describing the route
     */
     ...
     *
     * @return the last error which occured int the xml factory
     */
