...
\begin{tabular}{ | l | l | l | }
  ...
  \hline
  \bfit{Implémentation et tests} & \multicolumn{2}{r|}{\it{Sous-Total : 36 heures}} \\
  \hline
  Réalisation IHM & Hugues & 10 heures \\
  \hline
  Réalisation Modèle & Pierre, Lisa et Guillaume & 10 heures \\
  \hline
  Réalisation des contrôleurs & Estelle, Paul et Antoine & 15 heures \\
  \hline
  Diagramme rétro-générés & Antoine & 1 heures \\
  \hline
  %%%% Bilan
  \hline
  \bfit{Bilan} & \multicolumn{2}{r|}{\it{Sous-Total : 4 heures}} \\
  \hline
  Planning effectif & Antoine & 2 heures \\
  \hline
  Bilan humain et technique & Antoine & 2 heures \\
  \hline
  %%%% Total
  \hline
  \multicolumn{3}{|r|}{\bf{Total temps estimé :} 104,5 heures} \\
  \hline
\end{tabular}
\end{center}
...
\subsection{Explications pour le dépassement des estimations}
\label{subsec:explications-pour-le-depassement-des-estimations}

Comme présenté dans le planning effectif, nous avons fait un dépassement sur plusieurs estimations. Tout d'abord, il faut prendre en compte que nous avions peu d'expérience dans le domaine et c'est une qualité qui s'obtient avec l’entraînement et l'expérience.

Nous avions décidé d'utiliser l'outil JavaFX pour faire ce projet, sachant que nous n'avions aucune expérience avec ce dernier. Pour éviter de perdre du temps sur ce manque, nous avions nommé une personne du groupe pour avancer et explorer les opportunités pour l'interface graphique. Nous avons eu alors très rapidement un début d'interface. Le problème c'est que cette interface pour fonctionner devait faire l'impasse sur l'ensemble de la conception précédemment pensée, le temps que les autres composantes soient faites. Donc nous avons passé un certain temps à corriger et adapter la vue pour respecter les principes des différents patrons et la corréler avec les autres parties (modèle et contrôleur).
