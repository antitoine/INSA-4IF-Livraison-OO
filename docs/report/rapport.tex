...
\subsection{Textual description of \bfit{Load delivery request}}
...
\subsection{Textual description of \bfit{Compute a route}}
...
\subsection{Textual description of \bfit{Add a delivery}}
...
\subsection{Textual description of \bfit{Delete a delivery}}
...
\subsection{Textual description of \bfit{Swap two deliveries}}
\label{subsec:textual-description-of-swap-two-deliveries}

\Todo{Vérifier ce scénario par rapport au drive}
